...
$query_stmt = "SELECT product_id,name,buying_price,renting_price_per_day,cat_name FROM products p,categories c WHERE " . $category_cond . " AND p.category_id = c.category_id";
